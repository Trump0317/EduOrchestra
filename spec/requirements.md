...
| **Assistant** | 读全局状态 → 智能路由决策 | ✅ | plan, feedback, step_history, answers |
...
Chat Agent 不参与状态图，作为独立端点运行（v0.8+）。
...
| 2026-06-24 | v0.7：Planner/Diagnose 拆分 + Assistant 改为 LLM 智能路由器，五 Agent 架构 | AI + 用户 |
