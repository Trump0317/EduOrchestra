...
EduOrchestra 是一个**多智能体协作的模拟课堂**，面向高一学生数学自主学习。系统充当 AI 学习伙伴：学生设定学习任务，5 个 AI Agent 协作完成计划制定、资源搜集、做题练习、学情诊断和智能路由。
...
- **职责分离**：Planner 制定计划、Diagnose 诊断答题、Assistant 智能路由，每个 Agent 专注一件事
...
| **Assistant** | 读全局状态 → 智能路由决策（repeat/next/done） | ✅ | plan, feedback, step_history, answers |
